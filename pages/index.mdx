...
- Top Section: What to expect before becoming a validator. This includes this Welcome section, [Getting Started](/getstarted) & [New Validators](/companion/new) sections on the left side.
- Mid Section: [Official Companion Guide](/companion/official) Matches up to the official harmony document website section for section. We give you notes to know before you tackle the official documents that contain far too much information for other scenarios.
- Bottom Section: [Post install](/companion/post) what to do after your validator is created and what to expect.
