...
Our Documentation Guide repository has <Stars /> 🌟 on [GitHub](https://github.com/easy-node-one/guides). 

If you enjoy our guides can you head to [our page](https://github.com/easy-node-one/guides) and give us a 🌟 today? Thank you!
...
Harmony Validators verify each block produced on chain but beyond that there's two ways that people in the Harmony Ecosystem refer to a "Harmony Validator"
