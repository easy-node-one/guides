...
- **Validator Server Node** - The platform you use to create a wallet, create a validator, then later manage your "Harmony Validator Server Node" aka the computer running harmony using your wallet and your [bls keys](/companion/official/node#our-notes-on-bls-keys).
