...
Usually one of the first things to come up in chat is "When will I get rewarded?" and we can cover that here as well.

### Rewards as a Delegator

You've hit Delegate and signed over $ONE to be used on a validator, great! Now you want to know when you'll get paid.
