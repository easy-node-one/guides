...
If you've set up your node fully using our guide and have your stuff in ~/harmony you can skip to here to just [pull upgrade\_harmony.sh onto your node](/post/scripts/upgrade#pull-upgradeharmonysh-script-onto-your-node) without any further customizations.
...
11. Run our [stats script](/post/scripts/stats) to pull our stats
