...
This is option #12 in your menu. A reboot is not required but can sometimes be helpful if missing signatures. You can run updates while the harmony service is operating.
