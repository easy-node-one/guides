...
The top option is #1 in your menu to show your current server stats. If you don't use the toolbox, you can manually setup a [python stats script](/post/scripts/stats) to run by hand to see your sync status.

## Tools
Early in our guide we suggested installing some tools. If you have the [Admin Tools](/companion/new/tools) installed you should have MobaXterm all setup and ready to go. If you don't, head over to our Admin Tools section and work on getting yourself setup like a proper developer.
