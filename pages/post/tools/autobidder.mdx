...
We use [VS Code](/companion/new/tools#vs-code) with Remote SSH to manage the files, see our [Admin Tools](/companion/new/tools) post from earlier on that application.
