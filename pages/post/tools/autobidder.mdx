...
We use [VS Code](../../before-node-setup/admin-tools.md#vs-code) with Remote SSH to manage the files, see our [Admin Tools](../../before-node-setup/admin-tools.md) post from earlier on that application.
