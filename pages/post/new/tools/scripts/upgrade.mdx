...
If you didn't follow our full [Harmony Validator Companion Guide](/companion/new/) exactly, you may need to use your Linux administrator skills to modify some of the directories below.
...
If you've set up your node fully using our guide and have your stuff in ~/harmony you can skip to here to just [pull upgrade\_harmony.sh onto your node](/companion/post/tools/scripts/upgrade#pull-upgradeharmonysh-script-onto-your-node) without any further customizations.
...
11. Run our [stats script](/companion/post/tools/scripts/stats) to pull our stats
