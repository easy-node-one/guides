...
If you've set up your node fully using our guide and have your stuff in ~/harmony you can skip to here to just [pull upgrade\_harmony.sh onto your node](/post/new/tools/scripts/upgrade#pull-upgradeharmonysh-script-onto-your-node) without any further customizations.
...
11. Run our [stats script](/post/new/tools/scripts/stats) to pull our stats
