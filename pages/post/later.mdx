...
Here's some of the items that have been suggested and added to our issues board [here](https://github.com/easy-node-one/validatortoolbox/issues). 

Submit any ideas you have for the `validatortoolbox` on the github link above.
