# Our Software
An introduction to Easy Node Community - Harmony ONE Validators, BTC Vault Operators, & Software Developers
## About Easy Node
...
We first added to the community by producing a [living guide](https://companion.easynode.one) to use before/during/after installing the Harmony Validator Software.
...
## Github
Our validator toolbox software is now available on our [github page](https://github.com/easy-node-one) below!
