...
## Create A Wallet
See our notes on [setting up a wallet here](/companion/new/before#create-a-wallet) if you made it this far without one.

## BLS Keys
See our notes on [creating BLS Keys here]() but if you are this far you should already have these.
