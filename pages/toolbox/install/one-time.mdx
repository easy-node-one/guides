...
The next 3 sections need to be completed **after running the toolbox installer** but before running the management menu application. Since you're an existing validator you should have already completed everything in this guide. I've left this for new people who may be attempting to "jump the line".

## Create A Wallet
See our notes on [setting up a wallet here](/companion/new/wallet) if you made it this far without one.

## BLS Keys
See our notes on [creating BLS Keys here](/companion/new/blskeys) but if you are this far you should already have these.
