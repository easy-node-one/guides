...
## Server Prep
For full details on how to prep your first server from your provider, see our [Server Prep](/toolbox/prep/digitalocean) section first.
- ✔️ A new Ubuntu 20.04LTS server
  - ✔️ Login as a user account with sudoless root access or run and install as root
    -Digital Ocean Admins: Use the [User Data](/toolbox/prep/digitalocean#user-data) section from our main guide to do this automatically!
    -Other Providers Admins: Use the [Any Other Provider Guide](/toolbox/prep/others) on how to edit your [sudoers file](/toolbox/prep/others#sudoless-root-access-setup) or give access via groups.
  - ✔️ Volume Support
...
Continue onto our [Setup Menus](/toolbox/install/setup-menu) section of the main guide for more information on each available choice during our guided menu installer.
