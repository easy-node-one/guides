...
> We currently suggest using 550GB+ for your storage volume. Check with the [pangaea telegram chat](https://t.me/PangaeaVolunteers) or [harmony official discord](https://harmony.one/discord) to verify shard size if this is your first download.
