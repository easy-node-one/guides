...
- [Before Starting](/companion/new): What to expect before becoming a validator. Prospective New Validators should give this section a good read before attempting to install Harmony Validator Node Software.
- [Official Guide Companion](/companion/official): Matches up to the official harmony document website section for section. We give you notes to know before you tackle the official documents that contain far too much information for other scenarios.
- [Post Install Tips](/companion/post): what to do after your validator is created and what to expect.
