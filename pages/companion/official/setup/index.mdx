...
- Choose from a [regular Ubuntu server](/companion/companion/official/hardware/standard) or a [Raspberry Pi](/companion/companion/official/hardware/rasppi) for your node.
