...
## Updating a Node
You won't need to update a node at this point. However when you're ready to upgrade see our [Upgrade Script](/post/new/tools/scripts/upgrade) section if you'd like to script the upgrade process.
## Checking a Node
There's a few commands you're going to use here regularly to check things out, however if you set up our [Stats Script](/post/new/tools/scripts/stats) you can use that to check your status and use these sparingly as needed.
## Checking for BINGO
