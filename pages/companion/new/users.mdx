...
- If you're on windows use [Putty ](/companion/new/tools#other-windows-utility-applications) or the terminal to create ssh key pairs to connect to your servers terminal
...
You can update your `sudoers` file at this time but it's not required. 

[Here's a guide](https://www.linuxbabe.com/linux-server/setup-passwordless-ssh-login) covering ssh key pair creation and usage in depth. We highly suggest SSH key login and disabling password logins for security purposes.