...
In this section, set the export root as follows:

```bash
/data/findora/mainnet/
```
...
This section shows you how to create node.mnemonic in the right location with your validator mnemonic phrases for the software to utilize.
...
docker run -d -v /data/findora/mainnet/tendermint:/root/.tendermint -v /data/findora/mainnet/findorad:/tmp/findora -p 8669:8669 -p 8668:8668 -p 8667:8667 -p 8545:8545 -p 26657:26657 -e EVM_CHAIN_ID=2152 --name findorad findoranetwork/findorad:v0.3.25-release node --ledger-dir /tmp/findora --tendermint-host 0.0.0.0 --tendermint-node-key-config-path=/root/.tendermint/config/priv_validator_key.json --enable-query-service --enable-eth-api-service
```
