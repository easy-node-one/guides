...
### Create memonic file
Setup private phrase info for the `fn` application to access your wallet. If you need your mnemonic phrase `cat tmp.gen.keypair` will reveal these private words to you. This is a good time to back up your wallet file (tmp.gen.keypair) for restoration of your validator:
