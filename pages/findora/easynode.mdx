...
See [this link](https://wiki.findora.org/docs/guides/auto-setup#download-and-run-the-automated-setup-script) to get the most updated version of the **version_update_mainnet.sh** script to run.
...
```bash
wget https://wiki.findora.org/assets/files/update_version_mainnet-4f20384f16d1f0e2d90e1f7ebc7ea935.sh
```
...
```bash
bash -x update_version_mainnet-4f20384f16d1f0e2d90e1f7ebc7ea935.sh
```
