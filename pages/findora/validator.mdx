...
We suggest making one modification to the script before you run it! Run the following command to change the permissions line so it doesn't set permissions as root!
