...
- One guide to guide them all - Combined both guides into one for [https://guides.easynode.one](https://guides.easynode.one)
...
- Added Harmony Version Printout to bottom of the [Stats Script](/post/scripts/stats).
