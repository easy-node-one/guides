...
[Our Administrator Scripts](/post/tools/scripts/) - We have a script to pull your stats neatly and a script to upgrade your harmony client when needed. Modify them to fit your configuration.