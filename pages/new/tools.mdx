...
![Example new connection setup using the root account](/image_16.png)
...
![Example of updated connection setup using the serviceharmony account and going to ~/harmony on load](/image_8.png)
