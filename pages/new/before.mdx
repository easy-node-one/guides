...
<dl>
    <dt>In reality you should probably already have a few years of Linux systems administrations skills under your belt already if you decide to get into running a validator. Here's some things to be familiar with.</dt>
    <dd>Understand every command you run before you execute it and why you are performing it</dd>
    <dd>Be familiar with virtual machines and Ubuntu Server</dd>
    <dd>Know how to create, manipulate and update files and directories</dd>
    <dd>Know how to manage file permissions</dd>
    <dd>Know how to create users and manage permissions</dd>
    <dd>Know how to manage and modify bash scripts</dd>
    <dd>Know how to manage services</dd>
    <dd>Know how to read logs and troubleshoot issues that may arise.</dd>
</dl>
