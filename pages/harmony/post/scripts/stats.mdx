...
This is option #1 in your toolbox menu. You also have the option of getting your stats at anytime by using the included stats.py script customzied for the toolbox .env file:
```bash
python3 ~/validatortoolbox/harmony/toolbox/stats.py
```

## First Time or Non Toolbox Users
We've released a [python script](https://github.com/easy-node-one/harmony-validator-scripts/tree/main/stats) for finding stats on any server. You'll need to have python3 and pip3 installed for this to run.
