...
## Tools
Early in our guide we suggested installing some tools. If you have the [Admin Tools](/harmony/companion/new/tools) installed you should have MobaXterm all setup and ready to go. If you don't, head over to our Admin Tools section and work on getting yourself setup like a proper developer.
