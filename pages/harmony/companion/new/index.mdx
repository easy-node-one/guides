...
- Setup [scripts](/harmony/post/new/tools/scripts) to assist with management
<Callout type="warning" emoji="⚠️">
During **Installation** use [our middle section](/harmony/companion/official) **along with the official Harmony guide.**
</Callout>
