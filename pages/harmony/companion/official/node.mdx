...
## Setup
Remember to read our [Before I Set a Validator Up]/harmony/companion/new/before) section and make a plan before starting here. You'll want to have a non-root user account (with sudo access to run root commands is ok!) created and the ~/harmony directory setup.
...
[Here's our suggestions](/harmony/companion/new/blskeys) on how to create BLS Keys for your server.
<Callout emoji="ℹ️">
