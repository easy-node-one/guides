...
<Callout emoji="⚠️">
  This guide won't work out so well for absolutely new users. You should go through the [New Validator Companion Guide](/companion) and setup a node manually before you attempt the quick version.
</Callout>
