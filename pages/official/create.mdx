...
<div className="p-4 border border-gray-200 dark:border-gray-900 rounded mt-6">
<Callout emoji="⚠️">
  <p>Copy the entire command above and edit it yourself.</p>
  <p>**Extra white spaces in the command could cause errors.**</p>
  <p>**Decide on your max-change-rate & max-rate before sending your command. These cannot be modified once created.**</p><br />
  ...
  <p>**max-change-rate** - Maximum you can adjust your rate in a 24 hour period</p>
  <p>**max-rate** - Maximum rate you can charge as a fee on your validator</p>
