...
<div className="p-4 border border-gray-200 dark:border-gray-900 rounded mt-6">
<Callout emoji="⚠️">
  <p>Copy the entire command. **Extra white spaces in the command could cause errors.**</p>
  <p>**Decide on your max-change-rate & max-rate before sending your command. These cannot be modified once created.**</p>
